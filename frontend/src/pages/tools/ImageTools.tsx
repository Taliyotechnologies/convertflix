...
const ImageTools: React.FC = () => {
  ...
  const handleProcess = async () => {
    ...
    const processedFileInfo: FileInfo = {
      ...
      url: selectedFile.url // In real app, this would be the processed file URL
    };
    ...
    <div className="tools-page">
      <div className="container">
        <div className="tools-header">
          <h1 className="tools-title">Image Compression & Conversion</h1>
          <p className="tools-subtitle">
            Compress and convert your images to any format with quality preservation
          </p>
        </div>
              ...
              {!selectedFile ? (
                ...
                <div className="file-preview">
                  ...
                  <div className="file-info">
                    <h4 className="file-name">Image File</h4>
